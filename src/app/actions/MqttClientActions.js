...
class MqttClientActions {  
    ...
    static renameMqttClient(data) {
        AppDispatcher.dispatch({
            actionType: MqttClientConstants.ACTION_RENAME_MQTT_CLIENT,
            data: data
        });
    }

    static moveMqttClient(data) {
        AppDispatcher.dispatch({
            actionType: MqttClientConstants.ACTION_MOVE_MQTT_CLIENT,
            data: data
        });
    }

    static reorderMqttClient(data) {
        AppDispatcher.dispatch({
            actionType: MqttClientConstants.ACTION_REORDER_MQTT_CLIENT,
            data: data
        });
    }

    static updateMqttClientLayout(data) {
        AppDispatcher.dispatch({
            actionType: MqttClientConstants.ACTION_UPDATE_MQTT_CLIENT_LAYOUT,
            data: data
        });
    }

    static toggleFavoriteMqttClient(mcsId) {
        AppDispatcher.dispatch({
            actionType: MqttClientConstants.ACTION_TOGGLE_FAVORITE_MQTT_CLIENT,
            data: mcsId
        });
    }
